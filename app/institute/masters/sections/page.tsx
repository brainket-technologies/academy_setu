...
export default function SectionsPage() {
  ...
  useEffect(() => {
    ...
    if (savedClasses) {
      ...
      setClassList(['Class I', 'Class II', 'Class III', 'Class IV', 'Class V'])
    }
  }, [])
  ...
  const handleCreate = (e: React.FormEvent) => {
    e.preventDefault()
    if (!sectionNameInput || !targetClass) {
      alert('Please enter a Section name and select a Class.')
      return
    }
  ...
  const handleEditSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (!selectedSection || !sectionNameInput || !targetClass) return
  ...
  const handleDelete = (id: number) => {
    ...
    setSections(updated)
    localStorage.setItem('school_masters_sections', JSON.stringify(updated))
    showToast('Section moved to deleted list!')
  }
  ...
  const handleRestore = (id: number) => {
    ...
    setSections(updated)
    localStorage.setItem('school_masters_sections', JSON.stringify(updated))
    showToast('Section restored successfully!')
  }

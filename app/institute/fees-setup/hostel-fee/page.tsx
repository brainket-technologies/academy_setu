...
export default function HostelFeePage() {
  const [activeTab, setActiveTab] = useState('Hostel Fee Chart')
  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1200px] mx-auto w-full pb-10 animate-in fade-in duration-300">
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 shadow-sm flex items-center justify-between">
        ...
        <Link href="/institute/fees-setup/hostel-fee/create-type" className="px-4 py-2 flex items-center justify-center gap-2 rounded-lg bg-teal-600 text-white text-sm font-bold hover:bg-teal-700 transition-colors shadow-sm">
      ...
      {showForm && (
        <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm animate-in fade-in slide-in-from-top-4 duration-300">
          <h2 className="text-sm font-black text-slate-700 uppercase tracking-wider mb-6 pb-2 border-b border-slate-200">Create Hostel Fee Classwise</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6 mb-8">
            <div className="flex flex-col gap-1.5">
              <label className="text-[11px] font-bold text-slate-700">Hostel Type <span className="text-red-500">*</span></label>
              <select className="px-4 py-2.5 rounded-lg border border-slate-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-500">
                <option>Select Multiple Hostel</option>
              </select>
            </div>
            <div className="flex flex-col gap-1.5">
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <button onClick={() => setActiveTab('Hostel Fee Chart')} className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-[11px] font-bold border transition-colors ${
            activeTab === 'Hostel Fee Chart' ? 'bg-sky-100 text-sky-700 border-sky-200' : 'bg-sky-50 text-sky-600 border-sky-100 hover:bg-sky-100'
          }`}>
            Hostel Fee Chart <span className="bg-white text-sky-700 px-1.5 py-0.5 rounded text-[10px]">03</span>
          </button>
        ...
        <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700 relative min-h-[400px]">
          ...
          {activeTab !== 'Applicable Student' && activeTab !== 'Hostel Fee Chart' && (

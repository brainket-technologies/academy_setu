  ...
  return (
    <div className="flex flex-col gap-6 max-w-[1200px] mx-auto w-full pb-10 animate-in fade-in duration-300">
      ...
      {showForm && (
        ...
        <h2 className="text-sm font-black text-slate-700 uppercase tracking-wider mb-6 pb-2 border-b border-slate-200">Create Registration Amount Classwise</h2>
      ...
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <button onClick={() => setActiveTab('Registration Fee Chart')} className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-[11px] font-bold border transition-colors ${
            activeTab === 'Registration Fee Chart' ? 'bg-purple-100 text-purple-700 border-purple-200' : 'bg-purple-50 text-purple-600 border-purple-100 hover:bg-purple-100'
          }`}>
            Registration Fee Chart <span className="bg-white text-purple-700 px-1.5 py-0.5 rounded text-[10px]">03</span>
          </button>
        ...
        <div className="overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700 relative min-h-[400px]">
          ...
          {activeTab !== 'Applicable Student' && activeTab !== 'Registration Fee Chart' && (

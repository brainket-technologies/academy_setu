          ...
          <form onSubmit={handleUpdate} className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col-reverse md:flex-row gap-10">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2">
                        <select 
                          ...
                          className="w-24 px-3 py-2.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-slate-800 dark:text-slate-200"
                        >
                        ...
                        <input
                          ...
                          className="flex-1 px-4 py-2.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-slate-800 dark:text-slate-200"
                          required
                        />
                      </div>
                    </div>
                ...
                <div className="w-full md:w-64 flex flex-col items-center justify-center gap-4 bg-slate-50 dark:bg-slate-700/30 rounded-2xl p-6 border border-slate-100 dark:border-slate-700 shrink-0">
                  ...
                  <label className="flex items-center gap-2 px-6 py-2 text-indigo-600 dark:text-indigo-400 bg-white dark:bg-slate-800 border border-indigo-200 dark:border-indigo-800 hover:bg-indigo-50 dark:hover:bg-slate-700 rounded-lg text-sm font-semibold transition-colors cursor-pointer shadow-sm">
                ...
                <div className="flex flex-col gap-2 relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-slate-800 dark:text-slate-200 pr-10"
                    />
                    <button 
                      type="button"
            ...
            <div className="flex items-center justify-end gap-4 pt-4">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-10 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-sm transition-all shadow-md shadow-indigo-600/20 flex items-center gap-2"
              >

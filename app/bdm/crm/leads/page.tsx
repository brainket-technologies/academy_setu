...
import { 
  ...
  Download, FileUp, Save, Check, ArrowRightLeft, PhoneCall, Phone, MessageSquare, History
} from 'lucide-react'
...
export default function AllLeadsPage() {
  ...
  const fetchLeads = useCallback(async (page = 1, search = '', source = '', status = '') => {
    try {
      setLoading(true)
          ...
          {view === 'list' && (
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="px-4 py-2.5 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-xl font-bold text-sm transition-all flex items-center gap-2 cursor-pointer shadow-xs"
              >
              ...
              <button
                ...
                className="px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold text-sm shadow-md transition-colors flex items-center gap-2 cursor-pointer hover:scale-105 active:scale-95"
              >
                Create Lead
              </button>
            </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        fetchLeads(1, searchText, e.target.value, filterStatus)
                      }}
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <select
                      ...
                      onChange={e => {
                        ...
                        fetchLeads(1, searchText, filterSource, e.target.value)
                      }}

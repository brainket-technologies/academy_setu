...
import { MoreHorizontal, FileText, CheckCircle, Clock, CalendarDays, Key, MonitorPlay, Activity, TrendingUp, ShieldCheck } from 'lucide-react'
...
export default function BdmDashboardPage() {
  ...
  // Dynamic calculation for chart based on selected frequency
    ...
    <>
      <div className="flex flex-col gap-6 lg:gap-8 w-full pb-10">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="bg-gradient-to-br from-purple-50 to-fuchsia-50 dark:from-purple-950/20 dark:to-fuchsia-950/20 rounded-[28px] p-6 lg:p-8 shadow-sm border border-purple-100/50 dark:border-purple-900/30 flex flex-col justify-between">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5 flex-1">
              ...
              >
                <div>
                  <p className="text-[13px] font-semibold text-slate-500 dark:text-slate-400 mb-1 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">Total Lead</p>
              ...
              <Link
                href="/bdm/crm/followup?filter=today"
                className="bg-white dark:bg-slate-800 rounded-2xl p-5 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.05)] border border-slate-50 dark:border-slate-700/50 flex items-center justify-between hover:shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer group"
              >
                <div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8 items-stretch">
          ...
          {/* Analytics Section */}
          <div className="xl:col-span-2 bg-gradient-to-br from-indigo-50/40 to-violet-50/40 dark:from-slate-900 dark:to-slate-900 rounded-[28px] p-6 lg:p-8 shadow-sm border border-indigo-100/50 dark:border-slate-700/50 flex flex-col justify-between min-h-[360px]">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <select 
                      ...
                      className="bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold rounded-lg px-2.5 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                    >
                ...
                <div className="w-full h-[220px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={displayChartData} margin={{ top: 10, right: 10, left: -15, bottom: 0 }}>
                      <defs>
                        <linearGradient id="colorValueBdm" x1="0" y1="0" x2="0" y2="1">

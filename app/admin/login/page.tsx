  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-4 overflow-hidden bg-[#faf8ff] font-sans antialiased">
      ...
      <style>{`
        ...
        @keyframes streamB {
          0% { transform: translateX(0) translateY(0); }
          100% { transform: translateX(-68px) translateY(-68px); }
        }
        @keyframes orb-drift {
          ...
          <div className="relative p-10">
            ...
            <div className="flex justify-center mb-7">
              <div className="relative">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500 via-indigo-500 to-sky-400 flex items-center justify-center shadow-lg shadow-violet-200/50">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 bg-clip-text text-transparent tracking-tight leading-tight">
                Academy Setu
              </h1>
            ...
            {/* Footer */}
            <p className="text-center text-slate-400 text-xs mt-8 tracking-wide" suppressHydrationWarning>

...
import { 
  ...
  Download, FileUp, Save, Check, ArrowRightLeft, History, Phone, MessageSquare
} from 'lucide-react'
...
export default function ManagerLeadsPage() {
  ...
  // Switch to Edit View (inline page)
  ...
  return (
    <>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl px-8 py-5 border border-slate-100 dark:border-slate-700 shadow-sm shrink-0 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-850 dark:text-slate-100 tracking-tight">
              {view === 'edit' ? 'Edit Lead Details' : 'All Leads'}
            </h1>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              {view === 'edit' ? 'View and update lead details' : 'Monitor sales pipelines, leads logs, and assignments'}
            </p>
          </div>
          {view === 'list' && (
            <div className="flex items-center gap-3">
              <Link
                ...
                className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-sm shadow-md transition-colors flex items-center gap-2 cursor-pointer"
              >
          ...
          {view === 'edit' && (
            <div className="flex items-center gap-3">
              <button
                ...
                className="px-4 py-2 border border-slate-200 dark:border-slate-600 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-xl font-bold text-sm transition-colors flex items-center gap-2 cursor-pointer"
              >
      ...
      {/* Lead Logs Popup Modal (Redesigned 2-Column Split Layout) */}
                ...
                <form onSubmit={handleSubmitLogsModalUpdate} className="flex flex-col gap-4">
                  ...
                  {logsCommOption === 'Call' && (
                    <div className="flex flex-col gap-1.5 animate-in slide-in-from-top-1 duration-150">
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                      />
                    </div>
                  )}
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-1">
                      {['Not answering', 'Busy', 'Call later', 'Asked for demo', 'Meeting scheduled', 'Interested', 'Follow up next week', 'Wrong number'].map((item, i) => (
                        <button
                          ...
                          className="px-2 py-0.5 rounded-md bg-white dark:bg-slate-700 hover:bg-blue-50 dark:hover:bg-blue-900/40 hover:text-blue-600 dark:hover:text-blue-300 text-[11px] font-semibold text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-600 transition-colors cursor-pointer"
                        >
                          {item}
                        </button>
                      ))}
                    ...
                    <textarea
                      ...
                      required
                      className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <select
                        ...
                        required
                        className="w-full px-3.5 py-2.5 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl text-xs font-semibold text-slate-800 dark:text-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 cursor-pointer"
                      >
                        <option value="">Select Status</option>
                        {statuses.map(st => (
                          <option key={st.id} value={st.name}>{st.name}</option>
                  ...
                  <button
                    ...
                    className="w-full mt-1 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-bold shadow-md shadow-blue-500/20 transition-all cursor-pointer flex items-center justify-center gap-2 disabled:opacity-60"
                  >
                    {logsSubmitting ? (
                      <>
                        <Loader2 className="w-4 h-4 animate-spin" />
                            ...
                            <div className="flex items-start justify-between gap-3 mb-2">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {isTransfer ? (
                                  ...
                                  <span className="px-2.5 py-0.5 bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300 rounded-lg text-[10px] font-bold uppercase border border-blue-100 dark:border-blue-800 flex items-center gap-1">

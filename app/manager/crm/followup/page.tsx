...
function ManagerFollowupContent() {
  ...
  // Fetch Manager Session to get user name
  useEffect(() => {
  ...
  // Fetch Leads (filtered by server session)
    ...
    if (matched) {
      return (
        <span 
          ...
          style={{ 
            color: matched.text_color || '#2563eb',
            backgroundColor: matched.bg_color || 'rgba(37, 99, 235, 0.1)',
            borderColor: matched.text_color ? `${matched.text_color}40` : 'rgba(37, 99, 235, 0.2)'
          }}
        >
          {statusName}
        </span>
